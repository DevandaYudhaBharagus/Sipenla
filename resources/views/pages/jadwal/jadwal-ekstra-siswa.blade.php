                ...
                <div class="row justify-content-center mt-md-5 mt-3">
                    ...
                    <div class="col-md-2 col-6 me-md-3 mb-3 mb-md-0">
                        <div class="box-schedule">
                            ...
                            <div class="box-mapel-schedule">
                                <div class="box-mapel-schedule">
                                    <div class="content-schedule">{{ $l->extracurricular_name }}</div>
                    ...
                    <div class="col-md-2 col-6 me-md-3 mb-3 mb-md-0">
                        <div class="box-schedule">
                            ...
                            <div class="box-mapel-schedule">
                                <div class="box-mapel-schedule">
                                    <div class="content-schedule">{{ $r->extracurricular_name }}</div>
                    ...
                    <div class="col-md-2 col-6 me-md-3 mb-3 mb-md-0">
                        <div class="box-schedule">
                            ...
                            <div class="box-mapel-schedule">
                                <div class="box-mapel-schedule">
                                    <div class="content-schedule">{{ $k->extracurricular_name }}</div>
