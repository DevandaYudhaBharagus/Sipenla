                    ...
                    <tr>
                        ...
                        <td width="180px">
                            <div class="d-flex align-items-center justify-content-center">
                                <a  class="btn-edit-master me-2" data-id="{{ $new->lesson_schedule_id }}" onclick=edit_data($(this))><i class="fa fa-edit text-primary"></i></a>
                                    <a data-id="{{ $new->lesson_schedule_id }}" onclick=delete_data($(this)) class="btn-edit-master">
                    ...
                    <form id="form-schedule">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select" name="subject_id" id="subject_id" data-dropdown-parent="body" data-placeholder="Pilih Mata Pelajaran">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select" name="grade_id" id="grade_id" data-dropdown-parent="body" aria-label="Default select example">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <select class="form-select" name="teacher_id" id="teacher_id" data-dropdown-parent="body" data-placeholder="Pilih Guru">
                                    <option selected disabled value=''>--- Pilih Guru ---</option>
                                    @foreach ( $teachers as $teacher )
                                        <option value="{{ $teacher->employee_id }}">{{ $teacher->first_name.' '.$teacher->last_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 col-12">
                                <label for="day_id" class="form-label">Hari</label>
                                <select class="form-select" name="days_id" id="day_id" data-dropdown-parent="body" aria-label="Default select example">
...
@push('addon-javascript')
    ...
    <script>
        ...
        Array.prototype.filter.call($('#form-schedule'), function (form) {
            ...
            var url = (lesson_schedule_id !== undefined && lesson_schedule_id !== null) && lesson_schedule_id ? "{{ url('schedules')}}" + "/" + lesson_schedule_id : "{{ url('schedules')}}"+ "/addschedule";
            $.ajax({
                url: url,
                headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
