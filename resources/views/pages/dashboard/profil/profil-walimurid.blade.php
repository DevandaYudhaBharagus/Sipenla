                                    ...
                                    <div class="d-flex align-items-center mt-4">
                                        ...
                                        <div class="content-student-card">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="barrier-card">:</div>
                                                <div class="explain-card">{{ $guardian->nisn }}</div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="barrier-card">:</div>
                                                <div class="explain-card">{{ $guardian->address }}</div>
                                            </div>
                                            <div class="barcode-student">{!! DNS1D::getBarcodeHTML("$guardian->nisn", 'C128B') !!}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-biografi">
                                ...
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">{{ $guardian->nisn }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">
                                            {{ $guardian->first_name . ' ' . $guardian->first_name }}</div>
                                    </div>
                                </div>
                                {{-- <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->grade_name }}</div>
                                    </div>
                                </div> --}}
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->place_of_birth }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->date_of_birth }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->gender }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->father_name }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->mother_name }}</div>
                                    </div>
                                </div>
                                {{-- <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->email }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">
                                            {{ $guardian->employee_first_name . ' ' . $guardian->employee_last_name }}</div>
                                    </div>
                                </div>
                                <div class="box-text-biografi">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-1 text-center">:</div>
                                        <div class="col-8">{{ $guardian->extracurricular_name }}</div>
                                    </div>
                                </div> --}}
                            </div>
                        </div>
